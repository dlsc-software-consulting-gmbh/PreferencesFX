...
public class PreferencesFxModel {
  ...
  public PreferencesFxModel(
    ...
    if (getCategories().get(DEFAULT_CATEGORY).getGroups() == null && getCategories().get(DEFAULT_CATEGORY).getChildren() != null && getCategories().get(DEFAULT_CATEGORY).getChildren().size() > 0) {
