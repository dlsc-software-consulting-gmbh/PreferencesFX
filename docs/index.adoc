...
==== Started programming
Then we finally started programming. We don't wanted to spend any more time researching. So we just started and tried to write as fast as possible some code down to have something to work on. This helped a lot to have some satisfying experiences early in the project and keep motivated.
