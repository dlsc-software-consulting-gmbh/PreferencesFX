...
===== Eclipse RCP
image::images/alternatives/eclipse_rcp.png[]
image::images/alternatives/eclipse_rcp1.png[]

===== IOS
image::images/alternatives/ios_internal.jpg[]
image::images/alternatives/ios_external.jpg[]
...
image:images/alternatives/intellij.png[intellij,450]
image:images/alternatives/intellij_undoRedo.png[undo/redo,450,role="right"]
