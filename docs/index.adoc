...
===== MacOS
It was joyful to see how simple and clean the `macOS` constructs its preferences windows. This was really a contrast to the overwhelming preferences window of the `Eclipse RCP API`. We had a look
