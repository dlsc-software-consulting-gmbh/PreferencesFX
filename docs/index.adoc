...
As a result of our research we created a paper prototype, which was also the minimal viable product (MVP).
 Our promise to our customer, that he gets at least this product from us.
