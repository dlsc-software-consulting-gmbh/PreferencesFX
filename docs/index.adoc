...
[source,java]
----
include::{sourcedir}/com/dlsc/preferencesfx/standard/RootPane.java[tags=compareMatches]
----

image::images/setting_up_preferences.PNG[Setting up the preferences] image::method_call.PNG[The method, which is called]
